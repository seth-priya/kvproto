...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for MessageDiscard {}

impl MessageDiscard {
    pub fn new() -> MessageDiscard {
        ::std::default::Default::default()
    }

    pub fn default_instance() -> &'static MessageDiscard {
        static mut instance: ::protobuf::lazy::Lazy<MessageDiscard> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const MessageDiscard,
        };
        unsafe {
            instance.get(|| {
                MessageDiscard {
...
impl ::protobuf::Message for MessageDiscard {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn type_id(&self) -> ::std::any::TypeId {
        ::std::any::TypeId::of::<MessageDiscard>()
    }
...
impl ::protobuf::MessageStatic for MessageDiscard {
    fn new() -> MessageDiscard {
        MessageDiscard::new()
    }

    fn descriptor_static(_: ::std::option::Option<MessageDiscard>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                let fields = ::std::vec::Vec::new();
                ::protobuf::reflect::MessageDescriptor::new::<MessageDiscard>(
                    "MessageDiscard",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for MessageDiscard {
    fn clear(&mut self) {
        self.unknown_fields.clear();
    }
}

impl ::std::cmp::PartialEq for MessageDiscard {
    fn eq(&self, other: &MessageDiscard) -> bool {
        self.unknown_fields == other.unknown_fields
    }
}

impl ::std::fmt::Debug for MessageDiscard {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
pub struct Error {
    ...
    message_discard: ::protobuf::SingularPtrField<MessageDiscard>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::std::cell::Cell<u32>,
}
...
impl Error {
        ...
        unsafe {
            instance.get(|| {
                Error {
                    ...
                    message_discard: ::protobuf::SingularPtrField::none(),
                    unknown_fields: ::protobuf::UnknownFields::new(),
                    cached_size: ::std::cell::Cell::new(0),
                }
            })
    ...
    // optional .errorpb.MessageDiscard message_discard = 7;

    pub fn clear_message_discard(&mut self) {
        self.message_discard.clear();
    }

    pub fn has_message_discard(&self) -> bool {
        self.message_discard.is_some()
    }

    // Param is passed by value, moved
    pub fn set_message_discard(&mut self, v: MessageDiscard) {
        self.message_discard = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_message_discard(&mut self) -> &mut MessageDiscard {
        if self.message_discard.is_none() {
            self.message_discard.set_default();
        };
        self.message_discard.as_mut().unwrap()
    }

    // Take field
    pub fn take_message_discard(&mut self) -> MessageDiscard {
        self.message_discard.take().unwrap_or_else(|| MessageDiscard::new())
    }

    pub fn get_message_discard(&self) -> &MessageDiscard {
        self.message_discard.as_ref().unwrap_or_else(|| MessageDiscard::default_instance())
    }
}
...
impl ::protobuf::Message for Error {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !try!(is.eof()) {
            ...
            match field_number {
                ...
                7 => {
                    try!(::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.message_discard));
                },
                _ => {
                    try!(::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields()));
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.message_discard {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if let Some(v) = self.message_discard.as_ref() {
    ...
    fn descriptor_static(_: ::std::option::Option<Error>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor(
                    "message_discard",
                    Error::has_message_discard,
                    Error::get_message_discard,
                ));
...
impl ::std::cmp::PartialEq for Error {
    fn eq(&self, other: &Error) -> bool {
        ...
        self.message_discard == other.message_discard &&
        self.unknown_fields == other.unknown_fields
    }
}
...
static file_descriptor_proto_data: &'static [u8] = &[
    ...
    0x79, 0x22, 0x10, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x44, 0x69, 0x73, 0x63,
    0x61, 0x72, 0x64, 0x22, 0x90, 0x03, 0x0a, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x18, 0x0a,
    ...
    0x42, 0x75, 0x73, 0x79, 0x12, 0x40, 0x0a, 0x0f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f,
    0x64, 0x69, 0x73, 0x63, 0x61, 0x72, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e,
    0x65, 0x72, 0x72, 0x6f, 0x72, 0x70, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x44,
    0x69, 0x73, 0x63, 0x61, 0x72, 0x64, 0x52, 0x0e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x44,
    0x69, 0x73, 0x63, 0x61, 0x72, 0x64, 0x42, 0x0c, 0xc8, 0xe2, 0x1e, 0x01, 0xe0, 0xe2, 0x1e, 0x01,
    0xd0, 0xe2, 0x1e, 0x01, 0x4a, 0xdb, 0x0b, 0x0a, 0x06, 0x12, 0x04, 0x00, 0x00, 0x2c, 0x01, 0x0a,
    ...
    ,
    ...
    ,
    ...
    ,
    ...
    ,
];
