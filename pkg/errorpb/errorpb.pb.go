...
type MessageDiscard struct {
	XXX_unrecognized []byte `json:"-"`
}

func (m *MessageDiscard) Reset()                    { *m = MessageDiscard{} }
func (m *MessageDiscard) String() string            { return proto.CompactTextString(m) }
func (*MessageDiscard) ProtoMessage()               {}
func (*MessageDiscard) Descriptor() ([]byte, []int) { return fileDescriptorErrorpb, []int{5} }
...
type Error struct {
	...
	MessageDiscard   *MessageDiscard `protobuf:"bytes,7,opt,name=message_discard,json=messageDiscard" json:"message_discard,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}
...
func (m *Error) GetMessageDiscard() *MessageDiscard {
	if m != nil {
		return m.MessageDiscard
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*MessageDiscard)(nil), "errorpb.MessageDiscard")
...
func (m *MessageDiscard) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *MessageDiscard) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Error) MarshalTo(data []byte) (int, error) {
	...
	if m.MessageDiscard != nil {
		data[i] = 0x3a
		i++
		i = encodeVarintErrorpb(data, i, uint64(m.MessageDiscard.Size()))
		n7, err := m.MessageDiscard.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *MessageDiscard) Size() (n int) {
	var l int
	_ = l
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *MessageDiscard) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MessageDiscard: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MessageDiscard: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *Error) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MessageDiscard", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MessageDiscard == nil {
				m.MessageDiscard = &MessageDiscard{}
			}
			if err := m.MessageDiscard.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorErrorpb = []byte{
	...
	,
}
