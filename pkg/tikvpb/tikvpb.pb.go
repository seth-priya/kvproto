...
type TikvClient interface {
	...
	// stream.
	RawStream(ctx context.Context, opts ...grpc.CallOption) (Tikv_RawStreamClient, error)
}
...
func (c *tikvClient) RawStream(ctx context.Context, opts ...grpc.CallOption) (Tikv_RawStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Tikv_serviceDesc.Streams[2], c.cc, "/tikvpb.Tikv/RawStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &tikvRawStreamClient{stream}
	return x, nil
}

type Tikv_RawStreamClient interface {
	Send(*kvrpcpb.RawRequest) error
	Recv() (*kvrpcpb.RawResponse, error)
	grpc.ClientStream
}

type tikvRawStreamClient struct {
	grpc.ClientStream
}

func (x *tikvRawStreamClient) Send(m *kvrpcpb.RawRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *tikvRawStreamClient) Recv() (*kvrpcpb.RawResponse, error) {
	m := new(kvrpcpb.RawResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type TikvServer interface {
	...
	// stream.
	RawStream(Tikv_RawStreamServer) error
}
...
func _Tikv_RawStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TikvServer).RawStream(&tikvRawStreamServer{stream})
}

type Tikv_RawStreamServer interface {
	Send(*kvrpcpb.RawResponse) error
	Recv() (*kvrpcpb.RawRequest, error)
	grpc.ServerStream
}

type tikvRawStreamServer struct {
	grpc.ServerStream
}

func (x *tikvRawStreamServer) Send(m *kvrpcpb.RawResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *tikvRawStreamServer) Recv() (*kvrpcpb.RawRequest, error) {
	m := new(kvrpcpb.RawRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _Tikv_RawStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
...
var fileDescriptorTikvpb = []byte{
	...
	,
}
